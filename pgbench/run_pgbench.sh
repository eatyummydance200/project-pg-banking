...
# =========================================================================
# pgbench 동시성 부하 테스트 자동화 스크립트 (Linux, macOS, Git Bash용)
...
# 2. 테스트 설정
SQL_FILE="pgbench_transfer.sql"
DURATION=60

echo "=========================================================="
echo " Starting pgbench Banking Load Tests (Duration: ${DURATION}s)"
echo "=========================================================="
...
echo ""
echo "=========================================================="
echo " All pgbench load tests completed."
echo "=========================================================="
